...
<div class="subnav">
	<table border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td class="tabsubnav">
				<a href="?page=sales_mgr">DATA</a> &raquo; <b>TAMBAH Teknisi</b>
			</td>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="3">
	<form name="sales" action="?page=sales_add" method="post" onsubmit="return checkForm(this)">
		<tr>
			<td width="15%"><div class="tabtxt">ID sales</div></td>
			<td width="2%"><div class="tabtxt">:</div></td>
			<td width="83%">
				<input name="id" style="width:100px" type="textfield" class="tfield" value="<?php echo kdauto("sales","TK"); ?>" readonly>
			</td>
    </tr>          
    <tr>
...
<?php
	if($_POST['submit']){
	// tambah data sales via method
	//echo "$_POST['nama']";
	$nsb->tambahData($_POST['id'],$_POST['nama'],$_POST['ktp'],$_POST['tmpt_lahir'], 
                          tgl_ind_to_eng($_POST['tgl_lahir']),$_POST['alamat'],$_POST['telp']);
  echo '<META HTTP-EQUIV="Refresh" Content="0; URL=?page=sales_mgr">'; 
  }
?>
