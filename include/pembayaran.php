...
<table width="100%"  border="0" cellspacing="0" cellpadding="3">
	<form name="angsur" action="?page=pembayaran&aksi=update" method="post" onsubmit="return checkForm(this)">   
		...
		<tr>
			...
			<td>
				<input name="barang" id="barang" type="text" class="tfield" value="<?php echo $brg->bacatransaksi('nama_barang',$id) ;?>" readonly>			</td>
		</tr>
		<tr>
			<td valign="top"><div class="tabtxt">Harga</div></td>
			<td valign="top"><div class="tabtxt">:</div></td>
			<td>Rp. 
				<input name="hrg" id="hrg" type="text" class="tfield" value="<?php echo $brg->bacatransaksi('harga',$id);?>" readonly></td> 
		</tr>
        <tr>
			...
			<td>
				Rp. 
				<input name="dp" id="dp" type="text" class="tfield" value="<?php echo $brg->bacatransaksi('dp',$id);?>" readonly></td> 
		</tr>
		...
		<tr>
			...
			<td>
				Rp.			
				<input  name="selisih" id="selisih" type="text" class="tfield" value="<?php echo $brg->bacatransaksi('selisih',$id);?>" readonly></td> 
		</tr>
		<tr>
			<td><div class="tabtxt">Tanggal Bayar</div></td>
			<td><div class="tabtxt">:</div></td>
			<td>
				<input name="tgl" style="width:80px" type="textfield" id="tgl" class="tfield" readonly>
...
<?php
	...
	//echo "test";
	$brg->bayar($_POST['id'],$_POST['selisih'],tgl_ind_to_eng($_POST['tgl']));
